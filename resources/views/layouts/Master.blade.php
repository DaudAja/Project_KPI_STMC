...
<body class="d-flex">
    ...
    <nav class="sidebar shadow">
        <div class="sidebar-header">
            ...
            <small class="opacity-50 text-uppercase" style="font-size: 10px; letter-spacing: 1px;">Klinik Management</small>
        </div>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                ...
                <div class="ms-auto d-flex align-items-center">
                    ...
                    <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center text-white shadow-sm" style="width: 40px; height: 40px; background: var(--stmc-gradient) !important;">
