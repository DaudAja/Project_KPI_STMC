        ...
        <div class="col-md-8">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white py-3 border-bottom">
                    <h5 class="fw-bold mb-0 text-dark"><i class="bi bi-file-earmark-plus me-2 text-primary"></i> Input Surat Baru</h5>
                </div>
                    ...
                    <form action="{{ route('surat.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="nomor_surat" class="form-control @error('nomor_surat') is-invalid @enderror" placeholder="Contoh: 001/STMC/I/2026" required value="{{ old('nomor_surat') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_surat" class="form-control" placeholder="Contoh: Undangan Rapat Koordinasi" required value="{{ old('nama_surat') }}">
                        </div>

                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label small fw-bold text-secondary">TANGGAL SURAT</label>
                                <input type="date" name="tanggal_surat" class="form-control" required value="{{ old('tanggal_surat', date('Y-m-d')) }}">
                            </div>

                            <div class="col-md-6 mb-3">
                                <label class="form-label small fw-bold text-secondary">DOKUMEN BUKTI (WAJIB PDF)</label>
                                <input type="file" name="foto_bukti" class="form-control @error('foto_bukti') is-invalid @enderror" accept=".pdf" required>
                                @error('foto_bukti')
                            ...
                            <div class="mb-4 text-center d-none" id="pdf-alert">
                                <div class="alert alert-info small">
                                    <i class="bi bi-file-earmark-pdf-fill me-2"></i> File PDF telah terpilih dan siap diunggah.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <a href="/dashboard" class="text-decoration-none text-muted small"><i class="bi bi-arrow-left"></i> Batal</a>
                            <button type="submit" class="btn btn-primary px-5 rounded-pill shadow" style="background: var(--stmc-gradient); border: none;">
...
<script>
    document.querySelector('input[name="foto_bukti"]').addEventListener('change', function(e) {
        ...
        if (container && this.files.length > 0) {
            ...
            container.querySelector('.alert').innerHTML = `<i class="bi bi-file-earmark-pdf-fill me-2"></i> File <strong>${fileName}</strong> siap diunggah.`;
        }
    });
</script>
@endsection